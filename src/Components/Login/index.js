...
class Login extends Component {
  ...
  componentDidMount = () => {
    ...
    if (this.props.Type === "Formateur") {
      this.props.history.push("/formateur/recherchegroupe");
  ...
  handleSubmit = (event) => {
    if (
      ...
      if (this.state.Matricule === "") {
        Toast.fail(
          "veuillez saisir votre matricule!!".toUpperCase(),
          1000,
          () => {
            return;
          }
      ...
      if (this.state.MDP === "") {
        Toast.fail(
          "veuillez saisir votre mot de pass!!".toUpperCase(),
          1000,
          () => {
            return;
          }
      ...
      fetch("http://localhost/backend/utilisateurs/", requestOptions)
        ...
        .then((result) => {
          ...
          if (
            ...
            jsonObject.infos.Type === "Formateur"
          ) {
            ...
            jsonObject.status === "OK" &&
            jsonObject.infos.Type === "Gestionnaire"
          ) {
            Cookies.set("user", jsonObject);
            this.props.readCookie();
            Toast.success(
              "Bienvenue Gestionnaire!!".toUpperCase(),
              1000,
              () => {
                this.props.history.push("/gestionnaire/recherchegroupe");
              }
            ...
            Toast.fail(
              "Les informations insérée sont incorrectes".toUpperCase(),
              1000,
              () => {}
            );
          }
        ...
        .catch((error) => {
          Toast.fail(
            "les données saisies sont incorrectes!!".toUpperCase(),
            1000,
            () => {}
          );
        });
