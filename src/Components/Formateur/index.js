...
class RecharcheStagiairesFormateur extends Component {
  constructor(props) {
    super(props);
    this.state = {
      SELECTEDGROUPE: "",
    ...
    if (
      ...
      if (
        ...
        if (
          ...
          Toast.success(
            "L'absence n'est pas marqué OU aucun n'est pas absent",
            3000,
            () => {
              this.props.history.push({
                pathname: "/formateur/absences",
                state: {
            ...
            <Table.Header>
              <Table.Row>
                <Table.Cell className="text-center" colSpan="5">
                  <Label className="mt-3 " size="huge" color="blue" horizontal>
                    Gestion Absence
                  </Label>
                </Table.Cell>
              </Table.Row>
              ...
              <Table.Row>
                <Table.Cell colSpan="4">
                  <Button
                    ...
                    className="fluid ui teal button mt-3 mb-3"
                  >
                    Marquer l'Abscence
                  </Button>
                </Table.Cell>
